...
//FIXMEFIXME fnDim
            ...
            (*projOp).setSampleMode(1,xmin,xmax,xNsamp,xSampSplit,xSampType); // Need this even when subDef has been sampled to set variables used to construct y in projOp, when required
