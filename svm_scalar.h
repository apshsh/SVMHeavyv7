...
public:
    ...
    virtual const double &zR(int i) const { return ( i >= 0 ) ? zR()(i) : ((double &) y(i)); }
    ...
    virtual double dedgAlphaTrainingVector(int i, int j) const { double tmp; return dedgTrainingVector(tmp,i)*alphaR()(j); }
