...
int addtrainingdata(      ML_Base &mlbase, const char *trainfile, int reverse = 0, int ignoreStart = 0, int imax = -1, int ibase = -1);
int loadFileAndTest(const ML_Base &mlbase, const char *trainfile, int reverse = 0, int ignoreStart = 0, int imax = -1, int ibase = -1, int coercetosingle = 0, int coercefromsingle = 0, int fromsingletarget = 0, int binaryRelabel = 0, int singleDrop = 0);
