...
template <> inline double norm1 (const Vector<double> &a);
template <> inline double norm2 (const Vector<double> &a);
template <> inline double normp (const Vector<double> &a, double p);
template <> inline double absinf(const Vector<double> &a);
...
public:
    ...
    int contiguous(void)                 const { return !nbase || ( ( iis == 1 ) && ( pivot == cntintarray(dsize) ) ); }
...
//                    up all available memory and crashes the entire system!  I have no fucking *idea* why!
   ...
   virtual Vector<T> &subit (const T         &b) { if ( imoverhere ) { overhere().subit(b);  } else { throw("Not in FuncVector 15a"); } return *this; }
   virtual Vector<T> &addit (const T         &b) { if ( imoverhere ) { overhere().addit(b);  } else { throw("Not in FuncVector 16a"); } return *this; }
   virtual Vector<T> &mulit (const Vector<T> &b) { if ( imoverhere ) { overhere().mulit(b);  } else { throw("Not in FuncVector 17a");  } return *this; } // this*b
   virtual Vector<T> &rmulit(const Vector<T> &b) { if ( imoverhere ) { overhere().rmulit(b); } else { throw("Not in FuncVector 18a");  } return *this; } // b*this
   virtual Vector<T> &divit (const Vector<T> &b) { if ( imoverhere ) { overhere().divit(b);  } else { throw("Not in FuncVector 19a");  } return *this; } // this/b
   virtual Vector<T> &rdivit(const Vector<T> &b) { if ( imoverhere ) { overhere().rdivit(b); } else { throw("Not in FuncVector 20a");  } return *this; } // b\this
...
public: // because fuck it
    ...
    const T *unsafeccontent(void) const { return &((*ccontent)(zeroint()));    }
          T *unsafecontent (void) const { return &((*content)("&",zeroint())); }
    const int *unsafepivot (void) const { return &((*pivot)(zeroint()));       }
...
template <> inline double &twoProductNoConj (double &res, const Vector<double> &a, const Vector<double> &b);
template <> inline double &twoProductRevConj(double &res, const Vector<double> &a, const Vector<double> &b);
...
template <> inline Vector<double> operator+ (const Vector<double> &left_op);
template <> inline Vector<double> operator- (const Vector<double> &left_op);
...
template <> template <> inline Vector<double> &Vector<double>::scaleAdd(const double &a, const Vector<double> &b)
{
    ...
    else if ( size() && b.size() && contiguous() && b.contiguous() )
    {
        fastAddTo(&(*this)("&",zeroint()),&b(zeroint()),a,size());
    }
...
template <> inline double &oneProductAssumeReal(double &res, const Vector<double> &a)
{
    ...
    {
        fastoneProduct(res,&a(zeroint()),size);
    }

    else if ( size )
    {
        fastoneProduct(res,a.unsafeccontent(),a.unsafepivot(),a.unsafeib(),a.unsafeis(),size);
    }
...
template <> inline double &twoProduct(double &res, const Vector<double> &a, const Vector<double> &b)
{
    ...
    {
        fasttwoProduct(res,&a(zeroint()),&b(zeroint()),size);
    }

    else if ( size )
    {
        fasttwoProduct(res,a.unsafeccontent(),a.unsafepivot(),a.unsafeib(),a.unsafeis(),b.unsafeccontent(),b.unsafepivot(),b.unsafeib(),b.unsafeis(),size);
    }
...
template <> inline double &twoProductNoConj(double &result, const Vector<double> &left_op, const Vector<double> &right_op)
{
    return twoProduct(result,left_op,right_op);
}
...
template <> inline double &twoProductAssumeReal(double &result, const Vector<double> &left_op, const Vector<double> &right_op)
{
    return twoProduct(result,left_op,right_op);
}
...
template <> inline double &twoProductRevConj(double &result, const Vector<double> &left_op, const Vector<double> &right_op)
{
    return twoProduct(result,left_op,right_op);
}
...
template <> inline double &threeProduct(double &res, const Vector<double> &a, const Vector<double> &b, const Vector<double> &c)
{
    ...
    {
        fastthreeProduct(res,&a(zeroint()),&b(zeroint()),&c(zeroint()),size);
    }

    else if ( size )
    {
        fastthreeProduct(res,a.unsafeccontent(),a.unsafepivot(),a.unsafeib(),a.unsafeis(),b.unsafeccontent(),b.unsafepivot(),b.unsafeib(),b.unsafeis(),c.unsafeccontent(),c.unsafepivot(),c.unsafeib(),c.unsafeis(),size);
    }
...
template <> inline double &fourProduct(double &res, const Vector<double> &a, const Vector<double> &b, const Vector<double> &c, const Vector<double> &d)
{
    ...
    {
        fastfourProduct(res,&a(zeroint()),&b(zeroint()),&c(zeroint()),&d(zeroint()),size);
    }

    else if ( size )
    {
        fastfourProduct(res,a.unsafeccontent(),a.unsafepivot(),a.unsafeib(),a.unsafeis(),b.unsafeccontent(),b.unsafepivot(),b.unsafeib(),b.unsafeis(),c.unsafeccontent(),c.unsafepivot(),c.unsafeib(),c.unsafeis(),d.unsafeccontent(),d.unsafepivot(),d.unsafeib(),d.unsafeis(),size);
    }
...
template <> inline Vector<double> &operator*=(Vector<double> &left_op, const Vector<double> &right_op)
{
    ...
    if ( size && left_op.shareBase(right_op) )
    {
    ...
    else if ( size && right_op.size() && left_op.contiguous() && right_op.contiguous() )
    {
        fastMulBy(&left_op("&",zeroint()),&right_op(zeroint()),size);
    }
...
template <> inline Vector<double> &operator*=(Vector<double> &left_op, const double &right_op)
{
    ...
    {
        fastMulBy(&left_op("&",zeroint()),right_op,left_op.size());
    }
...
template <> inline Vector<double> &operator/=(Vector<double> &left_op, const Vector<double> &right_op)
{
    ...
    {
        fastDivBy(&left_op("&",zeroint()),&right_op(zeroint()),size);
    }
...
template <> inline Vector<double> &operator/=(Vector<double> &left_op, const double &right_op)
{
    ...
    if ( size && left_op.contiguous() )
    {
        fastDivBy(&left_op("&",zeroint()),right_op,left_op.size());
    }
...
template <> inline Vector<double> &operator+=(Vector<double> &left_op, const Vector<double> &right_op)
{
    ...
    {
        fastAddTo(&left_op("&",zeroint()),&right_op(zeroint()),size);
    }
...
template <> inline Vector<double> &operator+=(Vector<double> &left_op, const double &right_op)
{
    ...
    if ( size && left_op.contiguous() )
    {
        fastAddTo(&left_op("&",zeroint()),right_op,size);
    }
...
template <> inline Vector<double> &operator-=(Vector<double> &left_op, const Vector<double> &right_op)
{
    ...
    {
        fastSubTo(&left_op("&",zeroint()),&right_op(zeroint()),size);
    }
...
template <> inline Vector<double> &operator-=(Vector<double> &left_op, const double &right_op)
{
    ...
    if ( size && left_op.contiguous() )
    {
        fastSubTo(&left_op("&",zeroint()),right_op,size);
    }
...
inline const Vector<int> &zerointvec(int size, retVector<int> &tmpv)
{
    ...
    svmvolatile static Vector<int> zerores(zerointarray(MINZEROSIZE));
...
inline const Vector<int> &oneintvec(int size, retVector<int> &tmpv)
{
    svmvolatile static Vector<int> oneres(oneintarray(MINZEROSIZE));
...
inline const Vector<int> &cntintvec(int size, retVector<int> &tmpv)
{
    svmvolatile static Vector<int> cntres(cntintarray(MINZEROSIZE));
...
inline const Vector<double> &zerodoublevec(int size, retVector<double> &tmpv)
{
    svmvolatile static Vector<double> zerores(zerodoublearray(MINZEROSIZE));
...
inline const Vector<double> &onedoublevec(int size, retVector<double> &tmpv)
{
    svmvolatile static Vector<double> oneres(onedoublearray(MINZEROSIZE));
...
inline const Vector<double> &cntdoublevec(int size, retVector<double> &tmpv)
{
    svmvolatile static Vector<double> cntres(cntdoublearray(MINZEROSIZE));
