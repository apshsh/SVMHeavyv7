...
const DynArray<int> *hackyzerointarray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(delzerointarray,"dynarray: zerointarray",1);
        }
...
const DynArray<int> *hackyoneintarray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(deloneintarray,"dynarray: oneintarray",1);
        }
...
const DynArray<int> *hackycntintarray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(delcntintarray,"dynarray: cntintarray",1);
        }
...
const DynArray<double> *hackyzerodoublearray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(delzerodoublearray,"dynarray: zerodoublearray",1);
        }
...
const DynArray<double> *hackyonedoublearray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(delonedoublearray,"dynarray: onedoublearray",1);
        }
...
const DynArray<double> *hackycntdoublearray(int size, int isexit)
{
    ...
    if ( !vogonpoetry || ( size > maxsize ) )
    {
        ...
        if ( !vogonpoetry )
        {
            svm_atexit(delcntdoublearray,"dynarray: cntdoublearray",1);
        }
