...
svmvolatilemutex svm_mutex kernPrecursor::kerneyelock;
                         ...
                         int xdim, int m, int densetype, int resmode, int mlid) const
{
  ...
  {
    kernel8xx(q,res,q,typeis,txyprod,tyxprod,diffis,x,xinfo,iiii,xdim,m,densetype,resmode,mlid);
  }
                            ...
                            int xdim, int m, int mlid) const
{
    ...
    switch ( cType(q) )
    {
        ...
        {
            kernel8xx(q,res,minmaxind,cType(q),xyprod,yxprod,diffis,x,xinfo,i,xdim,m,0,16,mlid);
...
//OLD            res *= 2.0;
        ...
        case 890: case 891: case 892: case 893: case 894: case 895: case 896: case 897: case 898: case 899:
        {
            kernel8xx(q,res,minmaxind,cType(q),txyprod,tyxprod,diffis,x,xinfo,ii,xdim,m,0,32,mlid);
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    {
        (*(getAltCall(q,mlid))).K0xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xdim,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    {
        (*(getAltCall(q,mlid))).K1xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xainfo,ia,xdim,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    else
    {
        ...
        (*(getAltCall(q,mlid))).K2xfer(dummy,dummy,res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xainfo,xbinfo,ia,ib,xdim,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    {
        (*(getAltCall(q,mlid))).K3xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xc,xainfo,xbinfo,xcinfo,ia,ib,ic,xdim,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    {
        (*(getAltCall(q,mlid))).K4xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,ia,ib,ic,id,xdim,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int m, int densetype, int resmode, int mlid) const
{
    ...
    {
        (*(getAltCall(q,mlid))).K1xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,*(x(zeroint())),*(xinfo(zeroint())),i(zeroint()),xdim,densetype,resmode,mlid);
    }
    ...
    else if ( m == 2 )
    {
        ...
        (*(getAltCall(q,mlid))).K2xfer(dummy,dummy,res,minmaxind,typeis,xyprod,yxprod,diffis,*(x(zeroint())),*(x(1)),*(xinfo(zeroint())),*(xinfo(1)),i(zeroint()),i(1),xdim,densetype,resmode,mlid);
    }

    else if ( m == 3 )
    {
        (*(getAltCall(q,mlid))).K3xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,*(x(zeroint())),*(x(1)),*(x(2)),*(xinfo(zeroint())),*(xinfo(1)),*(xinfo(2)),i(zeroint()),i(1),i(2),xdim,densetype,resmode,mlid);
    }

    else if ( m == 4 )
    {
        (*(getAltCall(q,mlid))).K4xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,*(x(zeroint())),*(x(1)),*(x(2)),*(x(3)),*(xinfo(zeroint())),*(xinfo(1)),*(xinfo(2)),*(xinfo(3)),i(zeroint()),i(1),i(2),i(3),xdim,densetype,resmode,mlid);
    }

    else
    {
        (*(getAltCall(q,mlid))).Kmxfer(res,minmaxind,typeis,xyprod,yxprod,diffis,x,xinfo,i,xdim,m,densetype,resmode,mlid);
    }
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    (*(getAltCall(q,mlid))).K2xfer(dxyprod,ddiffis,res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xainfo,xbinfo,ia,ib,xdim,densetype,resmode,mlid);
