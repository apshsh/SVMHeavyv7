...
public:
    ...
    virtual int getparam (int ind, gentype         &val, const gentype         &xa, int ia, const gentype         &xb, int ib) const { return  SVM_Generic::getparam(ind,val,xa,ia,xb,ib); }
    virtual int egetparam(int ind, Vector<gentype> &val, const Vector<gentype> &xa, int ia, const Vector<gentype> &xb, int ib) const { return SVM_Generic::egetparam(ind,val,xa,ia,xb,ib); }
    ...
    virtual int setCweightfuzz(int i, double nw)                               { return getQ().setCweightfuzz(i,nw); }
    virtual int setCweightfuzz(const Vector<int> &i, const Vector<double> &nw) { return getQ().setCweightfuzz(i,nw); }
    virtual int setCweightfuzz(const Vector<double> &nw)                       { return getQ().setCweightfuzz(nw);   }
    ...
    virtual int normKernelNone                  (void)                              { return getQ().normKernelNone();                                   }
    ...
    virtual int                         findID(int ref) const { return getQconst().findID(ref);   }
    ...
    virtual double theta(void)   const { return getQconst().theta();   }
    virtual int    simnorm(void) const { return getQconst().simnorm(); }
    ...
    virtual int singmethod(void) const { return getQconst().singmethod(); }
    virtual double rejectThreshold(void) const { return getQconst().rejectThreshold(); }
    ...
    virtual int setVarBias(void)                           { return getQ().setVarBias();             }
    virtual int setPosBias(void)                           { return getQ().setPosBias();             }
    virtual int setNegBias(void)                           { return getQ().setNegBias();             }
    virtual int setFixedBias(double newbias = 0.0)         { return getQ().setFixedBias(newbias);    }
    virtual int setVarBias(int dq)                         { return getQ().setVarBias(dq);           }
    virtual int setPosBias(int dq)                         { return getQ().setPosBias(dq);           }
    virtual int setNegBias(int dq)                         { return getQ().setNegBias(dq);           }
    virtual int setFixedBias(int dq, double newbias = 0.0) { return getQ().setFixedBias(dq,newbias); }
    virtual int setFixedBias(const gentype &newBias)       { return getQ().setFixedBias(newBias);    }
    ...
    virtual int setFixedTube(void)  { return getQ().setFixedTube();  }
    virtual int setShrinkTube(void) { return getQ().setShrinkTube(); }

    virtual int setRestrictEpsPos(void) { return getQ().setRestrictEpsPos(); }
    virtual int setRestrictEpsNeg(void) { return getQ().setRestrictEpsNeg(); }

    virtual int setClassifyViaSVR(void) { return getQ().setClassifyViaSVR(); }
    virtual int setClassifyViaSVM(void) { return getQ().setClassifyViaSVM(); }
    ...
    virtual int setm(int xm) { return getQ().setm(xm); }
    ...
    virtual int setQuadBiasForce(double newval)         { int res = getQ().setQuadBiasForce(newval);                                               return res; }
    ...
    virtual int setQuadBiasForce(int dq, double newval) { int res = getQ().setQuadBiasForce(dq,newval);                                            return res; }

    virtual int setnu(double xnu)         { return getQ().setnu(xnu);         }
    virtual int setnuQuad(double xnuQuad) { return getQ().setnuQuad(xnuQuad); }

    virtual int settheta(double nv) { return getQ().settheta(nv); }
    virtual int setsimnorm(int nv)  { return getQ().setsimnorm(nv); }
    ...
    virtual int autosetLinBiasForce(double nuval, double Cval = 1.0) { return getQ().autosetLinBiasForce(nuval,Cval); }

    virtual void setanomalyclass(int n) { getQ().setanomalyclass(n); return; }
    virtual void setsingmethod(int nv) { getQ().setsingmethod(nv); return; }
    virtual void setRejectThreshold(double nv) { getQ().setRejectThreshold(nv); return; }
...
private:
    ...
    virtual       SVM_Generic &getQ     (void)       { if ( isQatonce ) { return static_cast<      SVM_Generic &>(Qatonce); } return static_cast<      SVM_Generic &>(Qredbin); }
    virtual const SVM_Generic &getQconst(void) const { if ( isQatonce ) { return static_cast<const SVM_Generic &>(Qatonce); } return static_cast<const SVM_Generic &>(Qredbin); }
