...
//         f for corresponding monotonic density kernel
//
// 900-999 get kernel evaluation from a server (i0 being a ref for kerni0.sock)
...
inline vecInfo &getvecscratch(void)
{
    svmvolatilemutex static svm_mutex eyelock;
...
*/
    ...
    // setMLid(): MLid is default > NUMMLINSTANCES/2 - use this to set to more sensible
...
private:
    ...
    int &xmlidcnt(void)
    {
        static int loccnt = NUMMLINSTANCES/2; 

        return ++loccnt;
    }

    svmvolatile static SparseVector<kernPrecursor *>* fullmllist;
    svmvolatilemutex static svm_mutex kerneyelock; 
};
...
public:
    ...
    const kernPrecursor *getAltCall(int q = 0, int currml = -1) const { (void) currml; NiceAssert( currml != altcallback(q) ); kernPrecursor *res = NULL; int ires = getaltML(res,altcallback(q)); NiceAssert( !ires ); (void) ires; return res; }
...
//    template <class T> void dnKKprosingle(T &res, const Vector<int> &gd, const T &xyprod, const T &diffis, int i, int j, int locindstart, int locindend, int xdim, int m, int isfirstcalc, T &scratch, const T &xxprod, const T &yyprod, int ktype, const gentype &weight, const Vector<gentype> &r, const Vector<int> &ic, int magterm) const;
    ...
    inline void diff0norm(gentype &res, const gentype &xyprod) const;
    inline void diff1norm(gentype &res, const gentype &xyprod, const gentype &xanorm) const;
    inline void diff2norm(gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm) const;
    ...
    inline void diff0norm(double &res, const double &xyprod) const;
    inline void diff1norm(double &res, const double &xyprod, const double &xanorm) const;
    inline void diff2norm(double &res, const double &xyprod, const double &xanorm, const double &xbnorm) const;
        ...
        if ( xisfast == -1 )
        {
          ...
          if ( xisfast == -1 )
          {
            ...
            if ( ( size() <= 1 ) || ( isnorm(zeroint(),1,size()-2,tmpva) == zeroint() ) )
            {
                ...
                else if ( !numSplits() && !numMulSplits() && 
                      ( ( size() >= 1 ) && ( ( isnorm(size()-1) == zeroint() ) || ( isAltDiff() <= 99 ) ) 
                                        && (    ( ( size() == 1 ) || ( ischain(zeroint(),1,size()-2,tmpva) == 1 ) ) 
                                             && ( cType(0) < 800 ) ) ) )
                {
                    // Could be xisfast == 2
                    //          2  if completely chained kernel where kernel 0 is either inner-product or diff, and remaining kernels are inner-product (no splits allowed or magterms)
...
public:
    ...
    int isSimpleXferKernel (void) const { return ( isSimpleKernel() && ( ( ( cType() >= 800 ) && ( cType() <= 829 ) ) || ( ( cType() >= 900 ) && ( cType() <= 999 ) ) ) ); }
    int isSimpleKernelChain(void) const { return ( ( size() == 2 )  && ( ( ( cType() >= 800 ) && ( cType() <= 829 ) ) || ( ( cType() >= 900 ) && ( cType() <= 999 ) ) )
...
inline
void MercerKernel::diff0norm(gentype &res, const gentype &xyprod) const
{
    (void) xyprod;
...
inline
void MercerKernel::diff1norm(gentype &res, const gentype &xyprod, const gentype &xanorm) const
{
    (void) xyprod;
    (void) xanorm;
...
inline
void MercerKernel::diff2norm(gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm) const
{
    res = xyprod;
    res *= -2.0;
    res += xanorm;
...
inline
void MercerKernel::diff0norm(double &res, const double &xyprod) const
{
    (void) xyprod;
...
inline
void MercerKernel::diff1norm(double &res, const double &xyprod, const double &xanorm) const
{
    (void) xyprod;
    (void) xanorm;
...
inline
void MercerKernel::diff2norm(double &res, const double &xyprod, const double &xanorm, const double &xbnorm) const
{
    res = xanorm+xbnorm-(2*xyprod);
                     ...
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, int justcalcip, int indstart, int indend) const
{
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        if ( !( isFastKernelSum() || isFastKernelChain() || justcalcip ) )
        {
            ...
            kernel8xx(0,prod,dummyind,cType(zeroint()),zzz,zzz,zzz,xdim,0,0,mlid);
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                kernel8xx(0,xyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xainfo,ia,xdim,0,0,mlid);
            }
            ...
            if ( needxxprod && !justcalcip )
            {
                ...
                kernel8xx(0,xaprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xainfo,ia,xdim,0,0,mlid);
            }
            ...
            else if ( ( size() >= 2 ) && needsDiff(1) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) && !justcalcip )
            {
                ...
                if ( isAltDiff() == 0 )
                {
                    ...
                    kernel8xx(0,xanorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xainfo,ia,xdim,0,0,mlid);
                }
                ...
                else
                {
                    ...
                    kernel8xx(0,xanorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xainfo,xainfo,ia,ia,xdim,0,0,mlid);
                }
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                kernel8xx(0,xyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,x,y,xinfo,yinfo,i,j,xdim,0,0,mlid);
            }
...
//errstream() << "phantomxyz mer 1\n";
                    kernel8xx(0,xxprod,dummyind,cType(zeroint()),zzz,zzz,zzz,x,x,xinfo,xinfo,i,i,xdim,0,0,mlid);
//errstream() << "phantomxyz mer 1b " << xxprod << "\n";
                    kernel8xx(0,yyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,y,y,yinfo,yinfo,j,j,xdim,0,0,mlid);
...
//errstream() << "phantomxyz mer 2\n";
                    kernel8xx(0,xnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,x,x,xinfo,xinfo,i,i,xdim,0,0,mlid);
//errstream() << "phantomxyz mer 2b" << xnorm << "\n";
                    kernel8xx(0,ynorm,dummyind,cType(zeroint()),zzz,zzz,zzz,y,y,yinfo,yinfo,j,j,xdim,0,0,mlid);
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                kernel8xx(0,xyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xb,xc,xainfo,xbinfo,xcinfo,ia,ib,ic,xdim,0,0,mlid);
            }
            ...
            if ( needxxprod && !justcalcip )
            {
                ...
                kernel8xx(0,xaprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xa,xainfo,xainfo,xainfo,ia,ia,ia,xdim,0,0,mlid);
                kernel8xx(0,xbprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xb,xbinfo,xbinfo,xbinfo,ib,ib,ib,xdim,0,0,mlid);
                kernel8xx(0,xcprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xc,xcinfo,xcinfo,xcinfo,ic,ic,ic,xdim,0,0,mlid);
            }
            ...
            else if ( ( size() >= 2 ) && needsDiff(1) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) && !justcalcip )
            {
                ...
                if ( isAltDiff() == 0 )
                {
                    ...
                    kernel8xx(0,xanorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xa,xainfo,xainfo,xainfo,ia,ia,ia,xdim,0,0,mlid);
                    kernel8xx(0,xbnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xb,xbinfo,xbinfo,xbinfo,ib,ib,ib,xdim,0,0,mlid);
                    kernel8xx(0,xcnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xc,xcinfo,xcinfo,xcinfo,ic,ic,ic,xdim,0,0,mlid);
                ...
                else
                {
                    ...
                    kernel8xx(0,xanorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xainfo,xainfo,ia,ia,xdim,0,0,mlid);
                    kernel8xx(0,xbnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xbinfo,xbinfo,ib,ib,xdim,0,0,mlid);
                    kernel8xx(0,xcnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xcinfo,xcinfo,ic,ic,xdim,0,0,mlid);

                    if ( needsMatDiff() )
                    {
                        kernel8xx(0,altxyr10,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xa,xbinfo,xainfo,ib,ia,xdim,0,0,mlid);
                        kernel8xx(0,altxyr20,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xa,xcinfo,xainfo,ic,ia,xdim,0,0,mlid);
                        kernel8xx(0,altxyr21,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xb,xcinfo,xbinfo,ic,ib,xdim,0,0,mlid);
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                kernel8xx(0,xyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,ia,ib,ic,id,xdim,0,0,mlid);
            }
            ...
            if ( needxxprod && !justcalcip )
            {
                ...
                kernel8xx(0,xaprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xa,xa,xainfo,xainfo,xainfo,xainfo,ia,ia,ia,ia,xdim,0,0,mlid);
                kernel8xx(0,xbprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xb,xb,xbinfo,xbinfo,xbinfo,xbinfo,ib,ib,ib,ib,xdim,0,0,mlid);
                kernel8xx(0,xcprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xc,xc,xcinfo,xcinfo,xcinfo,xcinfo,ic,ic,ic,ic,xdim,0,0,mlid);
                kernel8xx(0,xdprod,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xd,xd,xd,xdinfo,xdinfo,xdinfo,xdinfo,id,id,id,id,xdim,0,0,mlid);
            }
            ...
            else if ( ( size() >= 2 ) && needsDiff(1) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) && !justcalcip )
            {
                ...
                if ( isAltDiff() == 0 )
                {
                    ...
                    kernel8xx(0,xanorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xa,xa,xainfo,xainfo,xainfo,xainfo,ia,ia,ia,ia,xdim,0,0,mlid);
                    kernel8xx(0,xbnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xb,xb,xbinfo,xbinfo,xbinfo,xbinfo,ib,ib,ib,ib,xdim,0,0,mlid);
                    kernel8xx(0,xcnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xc,xc,xcinfo,xcinfo,xcinfo,xcinfo,ic,ic,ic,ic,xdim,0,0,mlid);
                    kernel8xx(0,xdnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xd,xd,xd,xdinfo,xdinfo,xdinfo,xdinfo,id,id,id,id,xdim,0,0,mlid);
                ...
                else
                {
                    ...
                    kernel8xx(0,xbnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xbinfo,xbinfo,ib,ib,xdim,0,0,mlid);
                    kernel8xx(0,xcnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xcinfo,xcinfo,ic,ic,xdim,0,0,mlid);
                    kernel8xx(0,xdnorm,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xd,xdinfo,xdinfo,id,id,xdim,0,0,mlid);
                    ...
                    if ( needsMatDiff() )
                    {
                        ...
                        kernel8xx(0,altxyr20,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xa,xcinfo,xainfo,ic,ia,xdim,0,0,mlid);
                        kernel8xx(0,altxyr21,dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xb,xcinfo,xbinfo,ic,ib,xdim,0,0,mlid);
                        kernel8xx(0,altxyr30,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xa,xdinfo,xainfo,id,ia,xdim,0,0,mlid);
                        kernel8xx(0,altxyr31,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xb,xdinfo,xbinfo,id,ib,xdim,0,0,mlid);
                        kernel8xx(0,altxyr32,dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xc,xdinfo,xcinfo,id,ic,xdim,0,0,mlid);
            ...
            else if ( needsDiff(0) && ( isAltDiff() >= 200 ) && ( isAltDiff() <= 299 ) && !justcalcip )
            {
                ...
                kernel8xx(0,altxy("&",z,z),dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xa,xainfo,xainfo,ia,ia,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",z,1),dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xb,xainfo,xbinfo,ia,ib,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",z,2),dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xc,xainfo,xcinfo,ia,ic,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",z,3),dummyind,cType(zeroint()),zzz,zzz,zzz,xa,xd,xainfo,xdinfo,ia,id,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",1,1),dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xb,xbinfo,xbinfo,ib,ib,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",1,2),dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xc,xbinfo,xcinfo,ib,ic,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",1,3),dummyind,cType(zeroint()),zzz,zzz,zzz,xb,xd,xbinfo,xdinfo,ib,id,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",2,2),dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xc,xcinfo,xcinfo,ic,ic,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",2,3),dummyind,cType(zeroint()),zzz,zzz,zzz,xc,xd,xcinfo,xdinfo,ic,id,xdim,0,0,mlid);
                kernel8xx(0,altxy("&",3,3),dummyind,cType(zeroint()),zzz,zzz,zzz,xd,xd,xdinfo,xdinfo,id,id,xdim,0,0,mlid);
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                kernel8xx(0,xyprod,dummyind,cType(zeroint()),zzz,zzz,zzz,x,xinfo,i,xdim,m,0,0,mlid);
            }
            ...
            if ( needxxprod && !justcalcip )
            {
                ...
                for ( ii = 0 ; ii < m ; ii++ )
                {
                    ...
                    kernel8xx(0,xxprod("&",ii),dummyind,cType(zeroint()),zzz,zzz,zzz,x("&",iii,tmpva),xinfo("&",iii,tmpvb),i("&",iii,tmpvc),xdim,m,0,0,mlid);
                }
            }
                ...
                if ( m )
                {
                    ...
                    for ( ii = 0 ; ii < m ; ii++ )
                    {
                        ...
                        if ( isAltDiff() == 0 )
                        {
                            ...
                            kernel8xx(0,xnormdex("&",ii),dummyind,cType(zeroint()),zzz,zzz,zzz,xx,xxinfo,iii,xdim,m,0,0,mlid);
                        }
                        ...
                        else
                        {
                            ...
                            kernel8xx(0,xnormdex("&",ii),dummyind,cType(zeroint()),zzz,zzz,zzz,*x(ii),*x(ii),*xinfo(ii),*xinfo(ii),i(ii),i(ii),xdim,0,0,mlid);
                            ...
                            if ( needsMatDiff() )
                            {
                                ...
                                if ( ii )
                                {
                                    for ( jj = 0 ; jj < ii ; jj++ )
                                    {
                                        if ( ii != jj )
                                        {
                                            kernel8xx(0,altxy("&",ii,jj),dummyind,cType(zeroint()),zzz,zzz,zzz,*x(ii),*x(jj),*xinfo(ii),*xinfo(jj),i(ii),i(jj),xdim,0,0,mlid);
                    ...
                    const double *xy00, const double *xy10, const double *xy11, int deepDeriv) const
{
    ...
    else if ( isFastKernelXfer() )
    {
        ...
        if ( ( !( size() >= 2 ) || !needsDiff(1) ) && deepDeriv )
        {
            ...
            dkernel8xx(0,xygrad,xnormgrad,xyprod,minmaxind,cType(zeroint()),zzz,zzz,zzz,x,y,xinfo,yinfo,i,j,xdim,0,48,mlid);
        ...
        else if ( ( size() >= 2 ) && needsDiff(1) && deepDeriv )
        {
            ...
            dkernel8xx(0,sxygrad,sxnormgrad,xyprod,minmaxind,cType(zeroint()),zzz,zzz,zzz,x,y,xinfo,yinfo,i,j,xdim,0,48,mlid);
            ...
            dkernel8xx(0,dxxgrad,dxnormgrad,xnorm,minmaxind,cType(zeroint()),zzz,zzz,zzz,x,x,xinfo,xinfo,i,i,xdim,0,48,mlid);
            dkernel8xx(0,dyygrad,dynormgrad,ynorm,minmaxind,cType(zeroint()),zzz,zzz,zzz,y,y,yinfo,yinfo,j,j,xdim,0,48,mlid);
