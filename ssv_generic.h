...
//WTF    virtual const vecInfo &xinfo(int i)           const { return SVM_Scalar::xinfo(i); }
    ...
    virtual void dgTrainingVectorX(Vector<gentype> &resx, int i) const { SVM_Scalar::dgTrainingVectorX(resx,i); return; }
    virtual void dgTrainingVectorX(Vector<double>  &resx, int i) const { SVM_Scalar::dgTrainingVectorX(resx,i); return; }
