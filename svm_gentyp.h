...
public:
    ...
    virtual int ggTrainingVector(double &resg,         int i, int retaltg = 0, gentype ***pxyprodi = NULL) const { gentype resgg; int res = ggTrainingVector(resgg,i,retaltg,pxyprodi); resg = (double)                 resgg; return res; }
    virtual int ggTrainingVector(Vector<double> &resg, int i, int retaltg = 0, gentype ***pxyprodi = NULL) const { gentype resgg; int res = ggTrainingVector(resgg,i,retaltg,pxyprodi); resg = (const Vector<double> &) resgg; return res; }
    virtual int ggTrainingVector(d_anion &resg,        int i, int retaltg = 0, gentype ***pxyprodi = NULL) const { gentype resgg; int res = ggTrainingVector(resgg,i,retaltg,pxyprodi); resg = (const d_anion &)        resgg; return res; }
