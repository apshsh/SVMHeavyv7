...
public:
    ...
    SparseVector<T> &zeroneari     (int i) { return zero(INDNEAROFFSTART+i);      }
    SparseVector<T> &zerofari      (int i) { return zero(INDFAROFFSTART+i);       }
    SparseVector<T> &zerofarfari   (int i) { return zero(INDFARFAROFFSTART+i);    }
    SparseVector<T> &zerofarfarfari(int i) { return zero(INDFARFARFAROFFSTART+i); }
    ...
    SparseVector<T> &zeroneari     (int i, int u) { return zero(INDNEAROFFSTART     +i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    SparseVector<T> &zerofari      (int i, int u) { return zero(INDFAROFFSTART      +i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    SparseVector<T> &zerofarfari   (int i, int u) { return zero(INDFARFAROFFSTART   +i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    SparseVector<T> &zerofarfarfari(int i, int u) { return zero(INDFARFARFAROFFSTART+i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    ...
    T &f  (const char *dummy, int i, int u) { return f  (dummy,i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    T &ff (const char *dummy, int i, int u) { return ff (dummy,i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    T &fff(const char *dummy, int i, int u) { return fff(dummy,i+(u*DEFAULT_TUPLE_INDEX_STEP)); }

    const T &n  (int i, int u) const { return n  (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    const T &f  (int i, int u) const { return f  (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    const T &ff (int i, int u) const { return ff (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    const T &fff(int i, int u) const { return fff(i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    ...
    int isindpresent(int i, int u) const { return isindpresent(i,(u*DEFAULT_TUPLE_INDEX_STEP)); }
    ...
    int isnearindpresent     (int i, int u) const { return isnearindpresent     (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    int isfarindpresent      (int i, int u) const { return isfarindpresent      (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    int isfarfarindpresent   (int i, int u) const { return isfarfarindpresent   (i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
    int isfarfarfarindpresent(int i, int u) const { return isfarfarfarindpresent(i+(u*DEFAULT_TUPLE_INDEX_STEP)); }
...
//    int res = 0;
    ...
    static svm_atomic<unsigned int> currid(0);

    return (unsigned int) currid++;
